...
The purpose of this project is to demonstrate ability to collect, work with, and clean a data set. The goal is to prepare a tidy data that can be used for later analysis. The following is to be submitted: 
...
Also included is a ``README.md`` in the repo with scripts. This repo explains how all of the scripts work and how they are connected.  
...
*``str`` is used in the R code for a snapshot or preview of the two final data sets.*